...
@if(count($usuarios)>0)
    ...
    @foreach($usuarios as $usuario)
        <tr>
            ...
            <td>
                <button class="btn btn-success edit_product" data-toggle="modal" data-target="#modalEditProducts" data-name="{{$usuario->name}}"
                        data-id="{{$usuario->id}}" data-email="{{$usuario->email}}" data-creditos="{{$usuario->creditos}}"
                ...
                >Editar</button>
                <button class="btn btn-danger deleteProduct"  data-id="{{$usuario->id}}"  data-toggle="modal" data-target="#confirmDeleteModal">Eliminar</button>
                <button class="btn btn-warning btnSetAdmin" style="margin-top: 10px"  data-id="{{$usuario->id}}"  data-toggle="modal" data-target="#l">Convertir Administrador</button>
